  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Justin beiber</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= route_to('admin') ?>" class="nav-link">
            ...
            <li class="nav-item">
            <a href="<?= route_to('admin/contact'); ?>" class="nav-link">
...
<div class="container">
                ...
                <tbody>
                    <?php foreach ($contact as $cont) : ?>
                            <tr>
                                ...
                                <td><?= $cont['message'] ?></td>
                                <td>
                                  <a href="<?= base_url('admin/edit/'.$cont['id']) ?>" class="btn btn-success btn-sm">Edit</a>   
                                </td>
                                  <td>
                                  <form action="<?= base_url('admin/delete/'.$cont['id']) ?>" method="POST">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2014-2021 <a href="<?= base_url(); ?>">Amit-kumar</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
