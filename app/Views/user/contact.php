      ...
      <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
        ...
        <div data-mdb-input-init class="form-outline mb-4">
          <label class="form-label" for="form1Example13">FullName</label>
            <input type="text" id="form1Example13" name="name" class="form-control form-control-lg" value="<?= set_value('name') ?>"/>
          ...
          <div data-mdb-input-init class="form-outline mb-4">
            ...
            <input type="text" id="form1Example23" name="message" class="form-control form-control-lg" value="<?= set_value('message') ?>" />
